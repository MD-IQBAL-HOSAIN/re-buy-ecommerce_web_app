...
@section('title', 'Condition Details')
        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <h4 class="mb-sm-0">Condition Details</h4>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    <h4 class="text-center mb-4">Condition Details</h4>
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th style="width: 200px;">Condition Name</th>
                                <td>{{ $data->name ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <th>Created At</th>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('condition.edit', $data->id) }}" class="btn btn-primary">
