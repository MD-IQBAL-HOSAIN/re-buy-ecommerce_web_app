...
@section('title', 'Dashboard | Create Buy Category')
        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <h4 class="mb-sm-0">Create Buy Category</h4>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    <form action="{{ route('buy-category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
