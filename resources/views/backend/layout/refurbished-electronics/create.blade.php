...
@section('title', 'Create Refurbished Electronic')
        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <h4 class="mb-sm-0">Create Refurbished Electronic</h4>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    <form action="{{ route('refurbished-electronics.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
