...
@section('content')
    {{-- PAGE-HEADER for How It Works start --}}
    <div class="page-header">
        <div>
            <h1 class="page-title">Header Of How It Works</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">How It Works Header</li>
            </ol>
        </div>
    </div>
    {{-- PAGE-HEADER for How It Works end --}}
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    <form action="{{ route('how-it-works-header.update') }}" method="POST">
                        @csrf
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">List of How It Works</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-2">
                        <a href="{{ route('how-it-works.create') }}" class="btn btn-primary">+ Add More</a>
                    </div>
...
@push('scripts')
    <script>
        ...
        function deleteItem(id) {
            let url = '{{ route('how-it-works.destroy', ':id') }}';
