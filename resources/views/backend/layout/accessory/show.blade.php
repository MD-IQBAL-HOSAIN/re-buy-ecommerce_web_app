        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <h4 class="mb-sm-0">Accessory Details</h4>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    <h4 class="text-center mb-4">Accessory Details</h4>
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th style="width: 200px;">Accessory Name</th>
                                <td>{{ $data->name ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <th>Description</th>
                            ...
                            <tr>
                                ...
                                <td>€{{ number_format($data->previous_price, 2) ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <th>Created At</th>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('accessory.edit', $data->id) }}" class="btn btn-primary">
