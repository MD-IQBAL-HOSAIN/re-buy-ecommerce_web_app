...
@section('title', 'Dashboard | Create Color')
                    ...
                    <form action="{{ route('color.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control"
                                value="{{ old('name') }}" placeholder="Enter color name (e.g., Red, Blue)">
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        {{-- Color Code --}}
                        <div class="mb-3">
                            <label for="code" class="form-label">Color Code (Hex) - (Not Mandatory)</label>
                            <div class="input-group">
                                <input type="color" name="color_picker" id="color_picker"
                                    class="form-control form-control-color" value="{{ old('code', '#000000') }}"
                                    title="Choose color" style="width: 60px;">
                                <input type="text" name="code" id="code" class="form-control"
                                    value="{{ old('code') }}" placeholder="#FF0000">
                            </div>
                            @error('code')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
