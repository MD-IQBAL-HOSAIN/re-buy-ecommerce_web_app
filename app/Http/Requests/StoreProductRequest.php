...
class StoreProductRequest extends FormRequest
{
    ...
    {
        return [
            'buy_subcategory_id' => 'required|integer|exists:buy_subcategories,id',
    ...
    {
        return [
            'buy_subcategory_id.required' => 'The subcategory field is required.',
            ...
            'image.mimes' => 'The thumbnail must be a file of type: jpeg, png, jpg, gif, svg, webp.',
            'image.max' => 'The thumbnail may not be greater than 5MB.',
            'images.*.image' => 'Each gallery image must be an image.',
            'images.*.mimes' => 'Gallery images must be files of type: jpeg, png, jpg, gif, svg, webp.',
