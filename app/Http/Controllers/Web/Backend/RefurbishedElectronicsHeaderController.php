...
class RefurbishedElectronicsHeaderController extends Controller
{
    /**
     * Show the form for editing the refurbished electronics header.
     *
     * @return \Illuminate\View\View
     */
    public function edit()
    {
        return view('backend.layout.refurbished-electronics.index');
    }

    /**
     * Update the refurbished electronics header.
     *
